...
func (lc *LanguageCreate) SetImageID(i int64) *LanguageCreate {
	lc.mutation.SetImageID(i)
	return lc
}

// SetNillableImageID sets the "image_id" field if the given value is not nil.
func (lc *LanguageCreate) SetNillableImageID(i *int64) *LanguageCreate {
	if i != nil {
		lc.SetImageID(*i)
	}
	return lc
...
func (lc *LanguageCreate) SetNillableUpdatedAt(t *time.Time) *LanguageCreate {
	if t != nil {
		lc.SetUpdatedAt(*t)
	}
	return lc
...
func (lc *LanguageCreate) SetID(i int64) *LanguageCreate {
	lc.mutation.SetID(i)
	return lc
}

// SetImage sets the "image" edge to the Image entity.
func (lc *LanguageCreate) SetImage(i *Image) *LanguageCreate {
	return lc.SetImageID(i.ID)
}
...
func (lc *LanguageCreate) createSpec() (*Language, *sqlgraph.CreateSpec) {
	...
	if nodes := lc.mutation.ImageIDs(); len(nodes) > 0 {
