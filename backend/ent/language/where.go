...
func ID(id int64) predicate.Language {
...
func IDEQ(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func IDIn(ids ...int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func IDNotIn(ids ...int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func IDGTE(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func IDLT(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func IDLTE(id int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func ImageID(v int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func ImageIDEQ(v int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldImageID), v))
	})
}
...
func ImageIDNEQ(v int64) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func ImageIDIn(vs ...int64) predicate.Language {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ImageIDNotIn(vs ...int64) predicate.Language {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ImageIDIsNil() predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func ImageIDNotNil() predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func HasImage() predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
...
func HasImageWith(preds ...predicate.Image) predicate.Language {
	return predicate.Language(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
