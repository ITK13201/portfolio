...
func (lq *LanguageQuery) QueryImage() *ImageQuery {
	query := &ImageQuery{config: lq.config}
...
func (lq *LanguageQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (lq *LanguageQuery) FirstIDX(ctx context.Context) int64 {
...
func (lq *LanguageQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (lq *LanguageQuery) OnlyIDX(ctx context.Context) int64 {
...
func (lq *LanguageQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (lq *LanguageQuery) IDsX(ctx context.Context) []int64 {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (lq *LanguageQuery) WithImage(opts ...func(*ImageQuery)) *LanguageQuery {
	query := &ImageQuery{config: lq.config}
...
func (lq *LanguageQuery) sqlAll(ctx context.Context) ([]*Language, error) {
	...
	if query := lq.withImage; query != nil {
		ids := make([]int64, 0, len(nodes))
		nodeids := make(map[int64][]*Language)
		for i := range nodes {
			fk := nodes[i].ImageID
