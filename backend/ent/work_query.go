...
func (wq *WorkQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WorkQuery) FirstIDX(ctx context.Context) int64 {
...
func (wq *WorkQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (wq *WorkQuery) OnlyIDX(ctx context.Context) int64 {
...
func (wq *WorkQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (wq *WorkQuery) IDsX(ctx context.Context) []int64 {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
